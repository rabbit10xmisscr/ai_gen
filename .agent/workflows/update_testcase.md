---
description: Cập nhật Kịch bản Kiểm thử Data Quality từ Use Case và Tài liệu Thiết kế Chi tiết
---

# WORKFLOW: Cập nhật Kịch bản Kiểm thử Data Quality từ Use Case và Tài liệu Thiết kế Chi tiết
...
Đây là bộ KBKT hiện tại của module ingestion.

## 2. Tài liệu thiết kế chi tiết

### Tài liệu chức năng

* `QT9.5.1.BM.04_Thiet ke chi tiet_Module chức năng Ingestion_FE.docx`

### Tài liệu API

* `QT9.5.1.BM.04_Thiet ke chi tiet_Module Tính năng Ingestion (API).docx`
...
**File:** `ULNL License Nâng cấp DMP 2025 QLCL check.xlsx`
...
`ULNL License Nâng cấp DMP 2025 QLCL check.xlsx`
...
`(UC347-560)DataQuality v1.0.xlsx`
...
* Đảm bảo đầy đủ các usecase có loại là `data quality` và Note ở cột KBKT là `chưa có`

* Đảm bảo vẫn giữ nguyên và không thay đổi gì ở sheet hiện có trên file KBKT ban đầu

* Đảm bảo sử dụng đúng form và và format của các cột có trong file KBKT ban đầu
