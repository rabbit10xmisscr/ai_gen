...
- Name: auth\login.spec.ts >> Login Feature >> TC02 - Đăng nhập thất bại: Sai mật khẩu
...
- button "×"
- text: "Login failed more than 5 times, please enter captcha code to login Hệ Thống Tổng Hợp, Phân Tích Và Trực Quan Hóa Dữ Liệu Tên đăng nhập: "
- textbox
- text: "Mật khẩu: "
- textbox
- img
